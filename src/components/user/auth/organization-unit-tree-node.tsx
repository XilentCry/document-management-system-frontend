...
import { ROOT_ORGANIZATION_UNIT_SLUG, UNIVERSITY_PRESIDENT_SLUG } from "@/lib/constants";
  ...
  return (
    <Collapsible open={open} onOpenChange={setOpen}>
      <div className="flex items-center gap-2 py-1">
        ...
        {node.slug !== ROOT_ORGANIZATION_UNIT_SLUG && node.slug !== UNIVERSITY_PRESIDENT_SLUG && (
          <Checkbox

...
import { useGetFolderDetails } from "@/features/folders/api/queries";
import { useGetItemActivities } from "@/features/items/api/queries";
import { useRailStore } from "@/features/drive/store/rail-store";
import { Folder, X } from "lucide-react";
import { ItemActivityList } from "@/features/items/components/item-activity-list";
...
import { ItemActivitySkeleton } from "@/features/items/components/item-activity-skeleton";
    ...
    <div className="border-l w-80 sticky top-14 flex flex-col h-[calc(100svh-56px)]">
      ...
      <div className="min-h-0 p-4 pt-0 flex-1 flex flex-col">
        ...
        >
          ...
          <TabsContent value="details" className="min-h-0 flex-1 flex flex-col">
            {isLoading ? (
